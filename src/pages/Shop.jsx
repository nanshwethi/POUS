        ...
        <div className=" w-[35vw] min-h-full bg-slate-950 flex flex-col print:w-full">
          ...
          <div className=" mt-auto ">
            <div className=" text-end pe-5 mt-3">
              ...
              <span className=" text-gray-200 text-2xl font-bold inline-block w-[100px] print:text-gray-600">
                {all}
              </span>
            </div>
            <div className=" text-end pe-5 mt-3 mb-2">
              <span className=" uppercase text-gray-300 me-3">tax - </span>
              <span className=" text-gray-200 text-xl font-bold inline-block w-[100px] print:text-gray-600">
                {" "}
                -{tax}
              </span>
            </div>
