...
const UserOverview = () => {
  ...
  const rows = elements.map((element) => (
    <tr className="" key={element.name}>
      <td className=" text-white">{element.position}</td>
      <td className=" text-white">{element.name}</td>
      <td className=" text-white">{element.symbol}</td>
      <td className=" text-white">{element.mass}</td>
    </tr>
  ));
  return (
    <div>
      <section className="container px-4 mx-auto font-roboto">
            ...
            <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
              <div className="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                  ...
                  <tbody className="bg-white text-start divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                    <tr>
