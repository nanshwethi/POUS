  ...
  return (
    <div className=' flex-1 bg-[#202124] p-5 px-6 min-h-screen'>
        ...
        <div className=' mt-[140px] flex'>
            <div className=' bg-[#171717] w-[55%] me-5'>
                <div className=' flex items-center ps-14'>
                    ...
                    <div className=' pt-12 px-10'>
                        ...
                        <div>
                            <p className=' text-gray-400 mb-2'>Sale Price : <span>10000 mmk</span></p>
                            <p className=' text-gray-400 mb-2'>Actual Price : <span>8000 mmk</span></p>
                        </div>
                    </div>
                </div>
                ...
                <div className=' mt-[20px] ps-14'>
                    ...
                    <div className=' flex pt-5 pb-12  text-gray-200 items-center font-medium'>
                        <div className=' w-48 font-semibold text-gray-400'>More Information</div> 
                        <div className=''>: fresh fruit</div>
                    </div>
                </div>
            </div>
