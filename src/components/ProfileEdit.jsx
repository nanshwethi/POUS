    ...
    <div className=" ms-[200px] bg-[#202124] relative">
          ...
          <div className=" flex gap-5 items-center  ps-14 ">
            <div className="relative">
              <div
                ...
                className=" rounded-full overflow-hidden mt-[-50px]"
              >
      ...
      <div className=" border border-b-0 border-t border-[#404044] myfooter w-full">
        <div className=" flex bg-[#121212] ps-24 py-4">
          <button className=" px-5 py-2 font-semibold text-[#7f8189] border me-4 text-xs uppercase border-[#646569] rounded">
            Cancel
          </button>
          <button className=" px-5 py-2 font-semibold text-[#292929] bg-[#8ab4f8] text-xs uppercase  rounded">
            Save
          </button>
        </div>
      </div>
