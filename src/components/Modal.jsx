...
console.log('sm',showModal)
  return (
    <div className={`${showModal?'flex':'hidden'} justify-center items-center absolute top-0 left-0 w-screen h-full  `} >
      <div className="z-20 absolute top-0 left-0 h-screen w-screen bg-black opacity-70"></div>
      <div className="z-30 min-w-[500px] min-h-[500px] flex flex-col justify-start items-center bg-[var(--sidebar-color)] border border-[var(--border-color)]">
