...
export const ReportStock = () => {
  ...
  useEffect(()=>{
    const sorted = brand?.currentData?.filter(i => i.total_brand_sale != 0).sort((a,b)=> b.total_brand_sale - a.total_brand_sale)
  ...
  return (
    <div className=" flex-1 bg-[#202124] p-5 px-6 min-h-[110vh] flex flex-col">
            ...
            <div className=" flex items-center justify-between mt-14">
              <div className=" w-[47%] ">
                ...
                <div className=" flex w-full items-center gap-3">
                  <div className=" flex w-[49%] items-center gap-5 border border-gray-700 px-5 rounded py-6">
                    ...
                    <div className=" text-gray-200 text-center">
                      <p className=" font-semibold text-5xl">
                        {brandReport?.currentData?.totalProducts}
                      </p>
                  ...
                  <div className=" flex w-[49%] items-center gap-5 border border-gray-700 px-5 rounded py-7">
                    ...
                    <div className=" text-gray-200 text-center">
                      <p className=" font-semibold text-5xl">
                        {brandReport?.currentData?.totalBrands}
                      </p>
                      ...
                      <Link to={"/report-lowstock"}>
                        <div className=" flex justify-between px-2 border-b border-gray-500 py-3">
                          ...
                          <div className=" text-gray-300 flex items-center">
                            <span className=" font-medium">100</span>
                            <span className=" ms-3 me-2  text-gray-300">
                              {brandReport?.currentData?.stocks?.lowStock?.substring(
                                0,
                                2
                              )}
                              %
              ...
              <div className=" border border-gray-700 rounded w-[52%] px-3 py-4">
                ...
                <div className=" flex items-end justify-between">
                  <div className=" w-1/2">
                    {
                     chartData != null && <BrandChart Data={chartData}/> 
                    }
                  </div>
                  <div className="">
                    <div className=" flex justify-between px-2 border-b border-gray-500 py-3">
                    ...
                    <div className=" flex justify-between px-2  py-3">
                      ...
                      <div className=" text-gray-300 flex items-center">
                        <span className=" font-medium">100</span>
                        <span className=" ms-3 me-2  text-gray-300">
                          {brandReport?.currentData?.stocks?.outOfStock?.substring(
                            0,
                            2
                          )}
                          %
                      ...
                      ? [...stock.currentData.data]
                          ...
                          .map((v, index) => (
                            <tr
                              ...
                              <td className="px-1 text-start py-4 ">
                                {v.brand}
                              </td>
