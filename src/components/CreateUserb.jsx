...
import { useAddUserMutation, useGetUserQuery } from "../redux/api/userApi";
...
//  const {name,setName,email,setEmail,password,setPassword,phone_number,setPhoneNumber,address,setAddress,gender,setGender,date_of_birth,setDateOfBirth,role,setRole,photo,setPhoto}=useContextCustom();
