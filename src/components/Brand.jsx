...
const Brand = () => {
  ...
  return (
    <div className=' flex-1 bg-[#202124] h-brand'>
        <div className=' h-full p-5 px-6 flex flex-col relative overflow-hidden'>
            <div className=''>
            ...
            <div className={` custom-offcanvas ${offcanvas && 'openAni'} bg-[#26272c] flex flex-col p-8`}>
                <div className=' '>
                    ...
                    <div className=' border border-dashed w-full h-[100px] relative border-gray-200 rounded mt-7 cursor-pointer bg-gray-700'>
                        ...
                        <input type='file' className=' absolute w-full h-full opacity-0 top-0 left-0 uploadImgInput' />
                    </div>
                    <div className=' pt-7'>
                        <div>
